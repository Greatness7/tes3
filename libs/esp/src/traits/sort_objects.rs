    ...
    pub fn sort_objects(&mut self) {
        ...
        isort(&mut indices, &self.objects, |object| {
            match object {
                ...
                TES3Object::SoundGen(obj)         => ( 7, obj.sort_hint(), obj.editor_id()),
                TES3Object::Skill(obj)            => ( 8, obj.sort_hint(), obj.editor_id()),
                TES3Object::MagicEffect(obj)      => ( 9, obj.sort_hint(), obj.editor_id()),
                TES3Object::Script(obj)           => (10, obj.sort_hint(), obj.editor_id()),
                TES3Object::Region(obj)           => (11, obj.sort_hint(), obj.editor_id()),
                TES3Object::Birthsign(obj)        => (12, obj.sort_hint(), obj.editor_id()),
                TES3Object::StartScript(obj)      => (13, obj.sort_hint(), obj.editor_id()),
                TES3Object::LandscapeTexture(obj) => (14, obj.sort_hint(), obj.editor_id()),
                TES3Object::Spell(obj)            => (15, obj.sort_hint(), obj.editor_id()),
                TES3Object::Static(obj)           => (16, obj.sort_hint(), obj.editor_id()),
                TES3Object::Door(obj)             => (17, obj.sort_hint(), obj.editor_id()),
                TES3Object::MiscItem(obj)         => (18, obj.sort_hint(), obj.editor_id()),
                TES3Object::Weapon(obj)           => (19, obj.sort_hint(), obj.editor_id()),
                TES3Object::Container(obj)        => (20, obj.sort_hint(), obj.editor_id()),
                TES3Object::Creature(obj)         => (21, obj.sort_hint(), obj.editor_id()),
                TES3Object::Bodypart(obj)         => (22, obj.sort_hint(), obj.editor_id()),
                TES3Object::Light(obj)            => (23, obj.sort_hint(), obj.editor_id()),
                TES3Object::Enchanting(obj)       => (24, obj.sort_hint(), obj.editor_id()),
                TES3Object::Npc(obj)              => (25, obj.sort_hint(), obj.editor_id()),
                TES3Object::Armor(obj)            => (26, obj.sort_hint(), obj.editor_id()),
                TES3Object::Clothing(obj)         => (27, obj.sort_hint(), obj.editor_id()),
                TES3Object::RepairItem(obj)       => (28, obj.sort_hint(), obj.editor_id()),
                TES3Object::Activator(obj)        => (29, obj.sort_hint(), obj.editor_id()),
                TES3Object::Apparatus(obj)        => (30, obj.sort_hint(), obj.editor_id()),
                TES3Object::Lockpick(obj)         => (31, obj.sort_hint(), obj.editor_id()),
                TES3Object::Probe(obj)            => (32, obj.sort_hint(), obj.editor_id()),
                TES3Object::Ingredient(obj)       => (33, obj.sort_hint(), obj.editor_id()),
                TES3Object::Book(obj)             => (34, obj.sort_hint(), obj.editor_id()),
                TES3Object::Alchemy(obj)          => (35, obj.sort_hint(), obj.editor_id()),
                TES3Object::LeveledItem(obj)      => (36, obj.sort_hint(), obj.editor_id()),
                TES3Object::LeveledCreature(obj)  => (37, obj.sort_hint(), obj.editor_id()),
                TES3Object::Cell(obj)             => (38, obj.sort_hint(), obj.editor_id()),
                TES3Object::Landscape(obj)        => (39, obj.sort_hint(), obj.editor_id()),
                TES3Object::PathGrid(obj)         => (40, obj.sort_hint(), obj.editor_id()),
